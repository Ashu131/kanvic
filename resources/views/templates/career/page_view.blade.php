        ...
        @endif
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 mt15">
                    <span class="">
                        <input type="text" name="patient_name" class="form-control" id="patient_name" placeholder="Name*" value="{{Input::old('patient_name')}}">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 mt15">
                    <span class="">
                        <input type="text" name="home_collection_Date" class="form-control datepicker1" placeholder="Preferred Home Collection Date*" readonly="readonly">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 carbannerborder">
        ...
        <div class="col-lg-5 col-md-6 col-sm-12">
            <div class="hs_how_we_are_text">
                <p style="font-size: 22px;line-height: 1.4;">If you are an entrepreneur or a laboratory which wished to learn to one of the brand - to earn returns in clinical chemistry business you can register here and we will pass it on to our channel partner who is present in your region.</p>
            </div>
                </div>
    </div>
</div>
...
<p class="text-danger">{{$errors->first('interest_location')}}</p>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 mt15">
            <span class="">
                    <select class="form-control" id="slider_select_dep" name="select_dep">
                          <option value="">How did you come to know about Dr. B. Lal</option>
 ...
 <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 mt15">
            <span class="">
              <input type="text" name="state" class="form-control" id="state" placeholder="State" value="{{Input::old('state')}}">
...
jQuery('.datepicker1').datepicker({minDate: 0,dateFormat: 'dd/mm/yy'});
