...
<div class="block block-themed">
 ...
 <div class="cf nestable-lists">
     <div class="dd" id="nestableMenu">
      <ol class="dd-list">
     @foreach($data['loyalty'] as $loyalti)
                <li class="dd-item dd3-item" data-id="{{$loyalti->loyalty_id}}">
                    <div class="dd-handle dd3-handle">Drag</div>
                    <div class="dd3-content">
                    <div class="producttitle">
                         {{$loyalti->loyalty_name}}
                    </div>
                   <div class="btncontanier">
                    <a href="{{route('edit.package.slug',$loyalti->loyalty_id)}}"> <i class="fa fa-lg fa-edit"></i></a>
                    <a href="javascript:delete_id({{$loyalti->loyalty_id}})">
...
<script src="{{url('resources/assets/admin/js/package_sort.js')}}"></script>
<script>
...
function delete_id(id)
{
     if(confirm('Sure To Remove This Record ?'))
     {
        ...
        window.location.href=baseurl+'/get/testimonial/deletetesti/'+id;
    }
}
</script>
