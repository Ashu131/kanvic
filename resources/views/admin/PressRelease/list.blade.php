...
<div class="block block-themed">
     <div class="block-header bg-primary">                
        <h3 class="block-title">Article list</h3>

    </div>
    <div class="block-content">
    <a href="{{url('admin/press-release/create')}}">Add new article</a>
 ...
 <div class="cf nestable-lists">
     ...
     @foreach($data['events'] as $event)
                <li class="dd-item dd3-item" data-id="{{$event->event_id}}">
                   ...
                   <div class="btncontanier">
                    <a href="{{route('edit.press-release.slug',$event->id)}}"> <i class="fa fa-lg fa-edit"></i></a>
                    <!--<a href="javascript:delete_id({{$event->id}})">
...
<script src="{{url('resources/assets/admin/js/event_sort.js')}}"></script>
<script>
...
function delete_id(id)
{
     if(confirm('Sure To Remove This Record ?'))
     {
        ...
        window.location.href=baseurl+'/get/event/delete/'+id;
    }
}
</script>
