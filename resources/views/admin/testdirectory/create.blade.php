...
<div class="block block-themed">
        <div class="block-header bg-primary">                
                <h3 class="block-title">Create New Test</h3>
        </div>
        ...
        <div class="block-content">
            ...
            <form class="form-horizontal page-form push-10-t push-10" action="{{route('test.post')}}" method="post" enctype="multipart/form-data">
