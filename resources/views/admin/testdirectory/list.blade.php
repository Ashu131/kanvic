...
<div class="block block-themed">
     <div class="block-header bg-primary">                
        <h3 class="block-title">Test Directory</h3>

    </div>
    <div class="block-content">
    <a href="{{url('admin/test-directory/create')}}">Add Test</a>
 ...
 <div class="cf nestable-lists">
     ...
     @foreach($data['tests'] as $test)
                <li class="dd-item dd3-item" data-id="{{$test->test_id}}">
                   ...
                   <div class="btncontanier">
                    <a href="{{route('edit.test.slug',$test->test_id)}}"> <i class="fa fa-lg fa-edit"></i></a>
                    <a href="javascript:delete_id({{$test->test_id}})">
...
<script src="{{url('resources/assets/admin/js/test_sort.js')}}"></script>
<script>
...
function delete_id(id)
{
     if(confirm('Sure To Remove This Record ?'))
     {
        ...
        window.location.href=baseurl+'/get/test/delete/'+id;
    }
}
</script>
